...
void setup(void) {
  ...
  while (true) {
    ...
    if (value_key_finger == 61 || value_key_finger == 39) {
...
//Hàm xử lý thông tin từ thẻ RFID 13.56MHz tham khảo thư viện
...
//Hàm xử lý thông tin từ thẻ RFID 125kHz có tham khảo
...
//hàm đăng kí vân tay tham khảo từ thư viện adafruit
...
//hàm đăng nhập vân tay tham khảo thư viện
...
// khởi tạo wifi tham khảo thư viện
void setupWifi() {
